...
//    FileReader fileReader = new FileReader(filePath);
    ...
    String translationCompC = jsonObject.getString("Translation");
    String[] lisTs = translationCompC.split("#");
%>
<!doctype html>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-8 col-12 mx-auto">
                    <h2 class="mb-lg-5 mb-4">Translation </h2>
                    ...
                    <div class="custom-block-info">
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/servlet/SaveTranslationAnswerServlet" name="form1" ��nsubmit="return on_submit()">

                            <input name="translation" style="width: 800px; height: 500px;" maxlength="200"><br>
