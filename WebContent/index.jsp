...
<%--		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ffffff" fill-opacity="1" d="M0,224L34.3,192C68.6,160,137,96,206,90.7C274.3,85,343,139,411,144C480,149,549,107,617,122.7C685.7,139,754,213,823,240C891.4,267,960,245,1029,224C1097.1,203,1166,181,1234,160C1302.9,139,1371,117,1406,106.7L1440,96L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path></svg>--%>
	...
	<div
			style="margin-top:-400px; background: url(${pageContext.request.contextPath}/images/index/background1.png)">
...
<%--		<div class="row">--%>
<%--			<div class="col-xs-4 ">--%>
<%--				<a href="${pageContext.request.contextPath}/servlet/getItemServlet?itemId=17">--%>
...
<%--			</div>--%>
<%--			<div class="col-xs-4 ">--%>
<%--				<a href="${pageContext.request.contextPath}/servlet/getItemServlet?itemId=15">--%>
<%--					<div class="caption">--%>
<%--						<div class="text-muted">--%>
<%--							<br />成绩查询--%>
<%--						</div>--%>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-item">
						<div class="icon" margin-top="200px">
							<img src="assets/images/service-01.png"  padding-top="200px" margin-top="200px" alt="online degrees">
						</div>
						<div class="main-content">
<%--							<button type="submit"--%>
<%--										data-toggle="modal" data-target="#apply" href="">--%>
<%--								进入报名--%>
<%--							</button>--%>
							<a type="submit"
							   data-toggle="modal" data-target="#apply" href=""><h4>进入报名</h4></a>
							<p>报名CET-6考试</p>
