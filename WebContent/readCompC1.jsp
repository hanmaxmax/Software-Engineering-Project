...
//    FileReader fileReader = new FileReader(filePath);
    ...
    // readComps[3]是原文，在此进行分段处理 begin
    String[] pharas =readCompCs[3].split("&&&");
    System.out.println("paras.len = "+pharas.length);
    // readComps[3]是原文，在此进行分段处理 end
    String[][] radios = new String[5][5]; // 题面+四个选项
    for(int j = 4; j < 9; j ++)
    {
        String[] strs = readCompCs[j].split("\\)");
        radios[j - 4][0] = strs[0].substring(0, strs[0].length() - 1);
        ...
        for(int k = 1; k < 5; k ++)
        {
            ...
            radios[j - 4][k] = sb.toString();
        }
//        radios[j - 4][2] = strs[2];
//        radios[j - 4][3] = strs[3];
//        radios[j - 4][4] = strs[4];
    }
//    String jsonContent = jsonObject.getString("Reading Comprehension SectionC");
//    String jsonContent1 = readCompCs[0];
//    String jsonContent2 = readCompCs[1];
//    String jsonContent3 = readCompCs[2];
//    String jsonContent4 = readCompCs[3];
//    String jsonContent51 = radios[0][0];
//    String jsonContent52 = radios[0][1];
//    String jsonContent53 = radios[0][2];
//    String jsonContent54 = radios[0][3];
//    String jsonContent55 = radios[0][4];
//    String jsonContent6 = readCompCs[5];
//    String jsonContent7 = readCompCs[6];
...
<%--                            <p>&nbsp;</p>--%>
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/servlet/SaveReadCompCServlet" name="form1" οnsubmit="return on_submit()">
