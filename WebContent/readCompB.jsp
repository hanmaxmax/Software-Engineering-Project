...
//    FileReader fileReader = new FileReader(filePath, "UTF-8");
    ...
    String readCompB = jsonObject.getString("Reading Comprehension SectionB");
    String[] readCompBs = readCompB.split("#");
    int i = 0;
    for (String s: readCompBs) {
        i++;
        System.out.println(i + ": " + s);
    }
    // readComps[0] Section B
    // readComps[1] Directions
    // readComps[2] 标题
    // readComps[3] 段A)
    // ... ...
    // readComps[14] 段L)
...
//    for(int j = 11; j < 16; j ++)
//    {
//        String[] strs = readCompBs[j].split("\\)");
...
<%--        var jsonContent1 = <%= readCompBs[0] %>;--%>
<%--        var jsonContent2 = <%= readCompBs[1] %>;--%>
<%--        var jsonContent3 = <%= readCompBs[2] %>;--%>
<%--        var jsonContent4 = <%= readCompBs[3] %>;--%>
...
<%--                            <pre style="width:680px; word-break: break-all; word-wrap: break-word; border: 1px; white-space:normal"><%= jsonContent1 %></pre>--%>
<%--                        "Section C"--%>
                            <p><strong><%= readCompBs[0] %></strong></p>
                            <br>
...
<%--                            <p>Many people asso<span style="font-size: 18px">ciate their self-worth with their work. The more successful their career,</span> the better they feel about themselves. Work-related self-esteem is therefore a worthy ideal to pursue with vigor, right? Well, not always. According to recent research, in which psychologists interviewed 370 full-time workers over a period of three weeks, the reality is a little more complicated. And it involves negative as well as positive consequences.&nbsp;It's natural to be drawn towards pleasure and to step away from pain. In the workplace, if that pleasure comes from a triumph which swells our self-respect, people will try to repeat the accomplishment. But repeating that accomplishment is often not realistic, which can lead to severe negative emotional consequences when it doesn't reoccur. This form of motivation is widely regarded as a negative type of motivation. It can hinder other more positive motivation types, such as completing a task purely because it's fulfilling or enjoyable. What consumes the employee instead is a pressing need to feel mighty and sure of themselves. They then take on only tasks and objectives which serve that ego-driven need. As a result, to avoid feelings of shame and worthlessness associated with failure, they extend themselves to such a degree that there's a subsequent adverse effect on their well-being. This internal pressure to succeed at all costs demands a lot of effort. It depletes their energy, culminating in disproportionate levels of damaging sentiment. What consumes the employee instead is a pressing need to feel mighty and sure of themselves. They then take on only tasks and objectives which serve that ego-driven need. As a result, to avoid feelings of shame and worthlessness associated with failure, they extend themselves to such a degree that there's a subsequent adverse effect on their well-being. This internal pressure to succeed at all costs demands a lot of effort. It depletes their energy, culminating in disproportionate levels of damaging sentiment. Those negative emotions mount into heightened anxiety, impacting their ability to make the most of their personal life. Their desire to avoid feeling inferior ends up making them feel inferior when it comes to their diminished capacity for friendship and leisure. They end up dissatisfied both at work and outside of it. But thankfully, for those people compelled almost entirely by this specific form of motivation, the news isn't all bad, or bad at all. The study also discovered several positive outcomes that can actually outweigh the harmful ones. Though these types of employees are motivated by the desire to avoid negative consequences, they are also motivated by the excitement of pursuing emotional rewards. This excitement makes pursuing goals enjoyable and stimulates pleasure and pride that would result from success. An effect of the positive motivation is that it neutralizes the existence of negative motivation. Sure, it affects people's personal lives to what could be deemed an unhealthy extent, because leisure activities are often seen as a part of life that must be sacrificed to manage work and family demands. However, the way people feel about their work has less to do with whether they're motivated by the preservation of self-esteem but more with the fact that they're simply motivated.</p>--%>
            ...
            <div class="right">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-12 mx-auto">
                        <em>Questions 36 to 45 are based on the following passage</em>
                        <!--
                          <div class="custom-block-image-wrap">
                              <img src="images/professional-golf-player.jpg" class="custom-block-image img-fluid" alt="">
                          </div>
...
<%--                            <%@ page contentType="text/html;charset=gb2312" %>--%>
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/servlet/SaveReadCompBServlet" name="form1" οnsubmit="return on_submit()">
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="6" id="RadioGroup1_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="7" id="RadioGroup1_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="8" id="RadioGroup1_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="9" id="RadioGroup1_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="10" id="RadioGroup1_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="11" id="RadioGroup1_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="12" id="RadioGroup1_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup2" value="6" id="RadioGroup2_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup2" value="7" id="RadioGroup2_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup2" value="8" id="RadioGroup2_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup2" value="9" id="RadioGroup2_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup2" value="10" id="RadioGroup2_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup2" value="11" id="RadioGroup2_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup2" value="12" id="RadioGroup2_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup3" value="6" id="RadioGroup3_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup3" value="7" id="RadioGroup3_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup3" value="8" id="RadioGroup3_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup3" value="9" id="RadioGroup3_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup3" value="10" id="RadioGroup3_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup3" value="11" id="RadioGroup3_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup3" value="12" id="RadioGroup3_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup4" value="6" id="RadioGroup4_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup4" value="7" id="RadioGroup4_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup4" value="8" id="RadioGroup4_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup4" value="9" id="RadioGroup4_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup4" value="10" id="RadioGroup4_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup4" value="11" id="RadioGroup4_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup4" value="12" id="RadioGroup4_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        D</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="5" id="RadioGroup5_4">
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="6" id="RadioGroup5_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="7" id="RadioGroup5_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="8" id="RadioGroup5_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="9" id="RadioGroup5_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="10" id="RadioGroup5_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="11" id="RadioGroup5_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup5" value="12" id="RadioGroup5_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        D</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="5" id="RadioGroup6_4">
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="6" id="RadioGroup6_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="7" id="RadioGroup6_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="8" id="RadioGroup6_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="9" id="RadioGroup6_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="10" id="RadioGroup6_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="11" id="RadioGroup6_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup6" value="12" id="RadioGroup6_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        D</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="5" id="RadioGroup7_4">
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="6" id="RadioGroup7_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="7" id="RadioGroup7_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="8" id="RadioGroup7_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="9" id="RadioGroup7_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="10" id="RadioGroup7_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="11" id="RadioGroup7_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup7" value="12" id="RadioGroup7_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        D</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="5" id="RadioGroup8_4">
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="6" id="RadioGroup8_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="7" id="RadioGroup8_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="8" id="RadioGroup8_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="9" id="RadioGroup8_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="10" id="RadioGroup8_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="11" id="RadioGroup8_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup8" value="12" id="RadioGroup8_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        D</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="5" id="RadioGroup9_4">
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="6" id="RadioGroup9_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="7" id="RadioGroup9_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="8" id="RadioGroup9_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="9" id="RadioGroup9_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="10" id="RadioGroup9_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="11" id="RadioGroup9_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup9" value="12" id="RadioGroup9_11">
                                        L</label>
                                </p>
                                ...
                                <p>
                                    ...
                                    <label>
                                        ...
                                        D</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="5" id="RadioGroup10_4">
                                        E</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="6" id="RadioGroup10_5">
                                        F</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="7" id="RadioGroup10_6">
                                        G</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="8" id="RadioGroup10_7">
                                        H</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="9" id="RadioGroup10_8">
                                        I</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="10" id="RadioGroup10_9">
                                        J</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="11" id="RadioGroup10_10">
                                        K</label>
                                    <label>
                                        <input type="radio" name="RadioGroup10" value="12" id="RadioGroup10_11">
                                        L</label>
                                </p>
