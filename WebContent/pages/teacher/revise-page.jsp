...
<%
    ...
    request.setAttribute("forwardUrl", "/pages/teacher/revise-page.jsp"); //map
%>
        ...
        <div class="col-md-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a
                                href="${pageContext.request.contextPath}/pages/teacher/revise-page.jsp">
                            <span class="glyphicon glyphicon-user"></span> 待批改
                        </a></li>
                        <li><a
                                href="${pageContext.request.contextPath}/pages/teacher/revise-examination.jsp"><span
                    ...
                    <table class="table table-striped" style="text-align: center">
                        ...
                        <c:forEach var="item" items="${requestScope.answerList}">
                            <tr>
                                ...
                                <!-- 提交到本页面，激活修改 -->
                                <td>
                                    <form action="${pageContext.request.contextPath}/../pages/teacher/grade.jsp" method="get">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group has-feedback">
                    <label for="account1">用户名</label>
                    <div class="input-group">
								<span class="input-group-addon"><span
                                        class="glyphicon glyphicon-user"></span></span> <input id="account1"
            ...
            <div class="modal-body">
                ...
                <form
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
								<span class="input-group-addon"><span
                                        class="glyphicon glyphicon-user"></span></span> <input id="account2"
                                                                                               name="account" class="form-control" readonly="readonly"
                                                                                               type="text" value="${param.account}">
                        </div>
                    </div>
