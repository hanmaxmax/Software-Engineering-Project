				...
				<div class="modal-body">
					<form
						...
						<div class="form-group has-feedback" id="register-password-div">
							<label for="register-password">身份证号</label>
							<div class="input-group">
								<span class="input-group-addon"><span
						...
						<form action="#">
							<label for="lang">考试轮次</label>
							<select name="考试轮次" id="lang">
						...
						<div class="text-right">
							...
							<button class="btn btn-primary" type="submit" data-dismiss="modal" data-toggle="modal" data-target="#apply-success">提&nbsp;&nbsp;交</button>
