...
<div id="payapply" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-title">
                <h1 class="text-center">缴费</h1>
            </div>

            <div class="modal-body">
                <form action="${pageContext.request.contextPath}/servlet/paymenttwoServlet?forwardUrl=${forwardUrl}" method="post">
                    <div class="form-group has-feedback">
                        <label for="apply-id">缴费序号</label>
                        <div class="input-group">
                            <span class="input-group-addon">
									<span class="glyphicon glyphicon-lock"></span>
								</span>
                            <input id="apply-id" name="regid" class="form-control"
                                placeholder="请输入缴费场次对应的 ID 序列号（第一列序号）" maxlength="10" type="text">
                        </div>
...
<div id="apply-fail" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-title">
                <h1 class="text-center">缴费失败，请勿重复缴费</h1>
            </div>
