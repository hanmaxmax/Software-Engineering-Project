...
<div id="apply" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="${pageContext.request.contextPath}/servlet/registrationServlet?forwardUrl=${forwardUrl}"
            ...
            <div class="modal-body">
                <div class="text-right">
                    <a class="btn btn-primary"
                       href="${pageContext.request.contextPath}/../pages/user/payment.jsp">前往缴费</a>
                    <button class="btn btn-primary" type="submit"
                            onclick="window.location.href='${pageContext.request.contextPath}${forwardUrl}'"
                            data-dismiss="modal">确 定
                    </button>
